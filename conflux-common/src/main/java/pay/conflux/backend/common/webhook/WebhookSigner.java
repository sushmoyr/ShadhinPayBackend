 ...
 * X-PGW-Signature} header value used for outbound webhook integrity. The signature is HMAC-SHA256
 * over the raw JSON request body, hex-encoded, using the merchant's webhook secret.
 */
@Component
public class WebhookSigner {

  public static final String SIGNATURE_HEADER = "X-PGW-Signature";
  ...
  /**
   * Compute the {@code X-PGW-Signature} header value for the given payload.
   *
   ...
   * @param secret merchant's {@code webhookSecret}
   * @param headerValue the value of the {@code X-PGW-Signature} header
   */
