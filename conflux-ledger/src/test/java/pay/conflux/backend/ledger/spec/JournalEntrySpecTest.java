...
class JournalEntrySpecTest {
  ...
  @Autowired private pay.conflux.backend.ledger.repository.JournalEntryRepository journalRepo;

  @Autowired private pay.conflux.backend.ledger.repository.LedgerAccountRepository accountRepo;

  @Autowired private pay.conflux.backend.ledger.repository.PostingRepository postingRepo;
