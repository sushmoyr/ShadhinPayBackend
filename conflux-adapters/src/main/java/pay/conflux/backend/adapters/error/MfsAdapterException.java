package pay.conflux.backend.adapters.error;
 ...
 * supports the requested {@link pay.conflux.backend.adapters.port.Vendor}, or an HTTP client cannot
 * be constructed for a vendor.
 *
 * <p>Adapters themselves should NOT throw this on vendor-side failures; vendor failures are encoded
 * in {@link pay.conflux.backend.adapters.port.VendorResponse} with a populated {@link ErrorCode}.
 * This exception is reserved for misconfiguration / programmer errors that surface to the global
 * {@code GlobalExceptionHandler} as {@code 502 BAD_GATEWAY}.
 */
