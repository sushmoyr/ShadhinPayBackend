 ...
 *       VendorResponse} with a populated {@link pay.conflux.backend.common.error.ErrorCode}. Throw
 *       only on programmer errors (null required arguments, malformed credentials).
