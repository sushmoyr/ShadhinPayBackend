package pay.conflux.backend.quota.config;
...
public class QuotaConfig {
  ...
  @Value("${conflux.quota.free-per-month:10}")
  private int freeQuotaPerMonth;

  @Value("${conflux.quota.pending-ttl-seconds:1800}")
  private long pendingTtlSeconds;

  @Value("${conflux.quota.final-ttl-seconds:3024000}")
